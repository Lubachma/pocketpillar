...
async function seedProvider(data: ProviderData, products: ProductData[]) {
  const provider = await prisma.pillar3aProvider.upsert({
    ...
    update: { name: data.name, description: data.description, website: data.website },
    create: { ...data },
  });
  ...
  await seedProvider(
    {
      slug: 'finpension',
      name: 'finpension',
      description: 'Pilier 3a digital à frais réduits',
  ...
  await seedProvider(
    {
      slug: 'ubs',
      name: 'UBS',
      description: 'UBS Vitainvest fonds de prévoyance',
  ...
  await seedProvider(
    {
      slug: 'swisscanto',
      name: 'Swisscanto',
      description: 'Fonds de prévoyance Swisscanto (ZKB)',
  ...
  await seedProvider(
    {
      slug: 'swiss-life',
      name: 'Swiss Life',
      description: 'Assurance-vie et pilier 3a lié',
  ...
  await seedProvider(
    {
      slug: 'zurich',
      name: 'Zurich',
      description: 'Solutions de prévoyance 3a Zurich Assurance',
  ...
  await seedProvider(
    {
      slug: 'baloise',
      name: 'Baloise',
      description: 'Assurance prévoyance 3a Baloise',
  ...
  await seedProvider(
    {
      slug: 'raiffeisen',
      name: 'Raiffeisen',
      description: 'Compte épargne et fonds 3a Raiffeisen',
  ...
  await seedProvider(
    {
      slug: 'migros-bank',
      name: 'Migros Bank',
      description: 'Compte épargne et fonds 3a Banque Migros',
  ...
  await seedProvider(
    {
      slug: 'bcv',
      name: 'BCV',
      description: 'Compte épargne 3a Banque Cantonale Vaudoise',
