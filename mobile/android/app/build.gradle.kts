...
android {
    ...
    defaultConfig {
        applicationId = "ch.pocketpillar.app"
        ...
        release {
            signingConfig =
                if (keystorePropertiesFile.exists()) {
                    ...
                    // Without a configured keystore: debug key (local builds only).
...
dependencies {
    ...
    // On-device OCR (document scanning) — in-house binding, see OcrPlugin.kt.
    // Gradle only: nothing is linked on the iOS side (Apple Vision there).
